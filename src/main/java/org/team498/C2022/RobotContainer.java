...
public class RobotContainer {
	...
	public RobotContainer() {
		...
		//wrist.setDefaultCommand(new SetWrist(wrist, driverControls.getWristState()));
		// intake.setDefaultCommand(intake.setState(driverControls.getIntakeState())));
	}
	...
	private void configureDriverBindings() {
		...
		driverControls.aButton.whenPressed(new SetWrist(wrist, Wrist.State.OUT));
		driverControls.bButton.whenPressed(new SetWrist(wrist, Wrist.State.IN));
	}
